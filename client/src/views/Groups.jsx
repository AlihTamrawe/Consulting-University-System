...
import { Card, CssBaseline, Grid, TextField, Button, Box, Typography, CardContent, MenuItem, Select, FormControl, InputLabel, CardMedia, CardActions } from '@mui/material/'
    ...
    >
      ...
      <Grid container spacing={2} marginTop="2px">
        ...
        >
          {load && filtergroups.map(groups =>
            <Card sx={{ width: 400, margin: '.5rem auto' }} elevation={4}>
              ...
              />
              <CardContent>
                <Typography gutterBottom variant="h5" component="div" color='#CFA76E'>
                  {groups.title}
                </Typography>
                ...
                <Typography variant="body2" color="#CFA76E">
                  added {formatDistanceToNow(new Date(groups.createdAt), { addSuffix: true })}
                </Typography>
              </CardContent>
              <CardActions>
                <Button
                  ...
                  onClick={!user ? () => navigate(`/login`) : () => navigate(`/group/${groups._id}/posts`)}
                >View Post...</Button>
              </CardActions>
            </Card>)}
        </Grid>
        ...
        <Grid item xs={12} md={3}>
          <Card sx={{ maxWidth: 450, margin: '0 1.3rem 0 .5rem', padding: '1rem 0 .5rem 1rem' }}>
            <CardContent>
              <Typography
                ml={1}
                align='left'
